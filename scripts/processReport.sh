...
while true; do
    ...
    curl -s -H "Authorization: Basic $(echo -n "elastic:$ELASTIC_PASSWORD" | base64)" "https://localhost:15601$url" -o "$output_file"
    
    # Verify if the response is different from "wait"
